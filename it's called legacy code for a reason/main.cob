       ...
       77 FORMATTED-RUPIAH      PIC 9(12).
       77 RUPIAH-AMOUNT         PIC 9(12) VALUE 0.
       77 CONVERSION-RATE       PIC 9(12) VALUE 97620.
       ...
       APPLY-ACTION.
           ...
           EVALUATE IN-ACTION
               ...
               WHEN "BAL"
                   ...
                   MOVE " = IDR" TO EQUAL-TO
                   MOVE FORMATTED-AMOUNT TO BALANCE-ALPHA
                   MULTIPLY TMP-BALANCE BY CONVERSION-RATE
                          GIVING RUPIAH-AMOUNT
                   STRING BALANCE-TEXT DELIMITED SIZE
                          BALANCE-ALPHA DELIMITED SIZE
                          EQUAL-TO DELIMITED SIZE
                          RUPIAH-AMOUNT DELIMITED SIZE
                          INTO OUT-RECORD
               WHEN OTHER
